...
type UserManagementClient interface {
	...
	GetUser(ctx context.Context, in *GetUsersParams, opts ...grpc.CallOption) (*UserList, error)
}
...
func (c *userManagementClient) GetUser(ctx context.Context, in *GetUsersParams, opts ...grpc.CallOption) (*UserList, error) {
	out := new(UserList)
...
type UserManagementServer interface {
	...
	GetUser(context.Context, *GetUsersParams) (*UserList, error)
}
...
func (UnimplementedUserManagementServer) GetUser(context.Context, *GetUsersParams) (*UserList, error) {
...
func _UserManagement_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserManagementServer).GetUser(ctx, req.(*GetUsersParams))
	}
	return interceptor(ctx, in, info, handler)
}
